...
from train_methods import ExperienceMemory, step_logging_fun, gather_exp_via_rollout, \
    flatten_parallel_rollout, CsvLogger
...
class DQNAlgo(object):
    ...
    def __init__(self, env:gym.Env, agent:QModel, target_model, num_rollout_steps=None, target_model_update_interval=10,
        ...
        self.optimizer = RMSprop(self.agent.parameters(), lr,alpha=rmsprop_alpha,eps=rmsprop_eps)
