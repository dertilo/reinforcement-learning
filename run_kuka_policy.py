...
from kuka_robot import KukaRobotEnv, PolicyAgent


def enjoy_kuka(model_file):
    agent:PolicyAgent = torch.load(model_file)
    agent.eval()
    ...
    while True:
        ...
        for t in tqdm(range(1, 10000)):  # Don't infinite loop while learning
...
if __name__ == "__main__":
    ...
    # model_file = os.environ["HOME"] + "/data/kuka_models/model.pt"
